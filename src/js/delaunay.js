...
/*
	Modifications made by Nathaniel Gibson
		uses a kd-Tree to sort the triangles by 2 angles + area where triangle is 0 rotated
		create a triangular lattice from 
*/
...
function AddVertex( vertex, triangles )
{
	...
	//edit: NDG.unique edges used to sort triangles as kdTree
	for( i in edges )
	{
		var edge = edges[i];
...
function UniqueEdges( edges )
{
	...
	// NDG: kdTree here as well?, 4 dimensional distance equation?
	var uniqueEdges = [];
	for( var i in edges )
	{
		var edge1 = edges[i];
